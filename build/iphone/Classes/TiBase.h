...
// in simulator we redefine to format for Lent2011 Developer console
...
{\
	NSString * exceptionName = [@"org.lent2011." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lent2011";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILent2011NativeItemNone = -1, 
	UILent2011NativeItemSpinner = -2,
	UILent2011NativeItemProgressBar = -3,
	
	UILent2011NativeItemSlider = -4,
	UILent2011NativeItemSwitch = -5,
	UILent2011NativeItemMultiButton = -6,
	UILent2011NativeItemSegmented = -7,
	
	UILent2011NativeItemTextView = -8,
	UILent2011NativeItemTextField = -9,
	UILent2011NativeItemSearchBar = -10,
	
	UILent2011NativeItemPicker = -11,
	UILent2011NativeItemDatePicker = -12,
	
	UILent2011NativeItemInfoLight = -13,
	UILent2011NativeItemInfoDark = -14,
	
	UILent2011NativeItemDisclosure = -15,
	
	UILent2011NativeItemContactAdd = -16
};
