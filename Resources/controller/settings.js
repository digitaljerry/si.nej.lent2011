...
Titanium.include (Titanium.App.Properties.getString('include')+'model/settings.js');

//
// Load UI elements
//
Titanium.include (Titanium.App.Properties.getString('include')+'view/settings.js');
