...
function showEventsForStage(location_uid) {
	...
	//var geturl = 'http://' + Titanium.App.Properties.getString('domain') + '/index.php?id=ag_lent_webservice&ag_lent_webservice[lang]='+lang['name']+'&ag_lent_webservice[action]=getLocationEvents&ag_lent_webservice[id]='+location_uid;
	var geturl = 'http://' + Titanium.App.Properties.getString('domain') + '/index.php?eID=ag_lent_webservice&ag_lent_webservice[lang]='+lang['name']+'&ag_lent_webservice[action]=getLocationEvents&ag_lent_webservice[id]='+location_uid;
