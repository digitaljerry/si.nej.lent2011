...
Titanium.include (Titanium.App.Properties.getString('include')+'model/stages_detail.js');

//
// Load UI elements
//
Titanium.include (Titanium.App.Properties.getString('include')+'view/stages_detail.js');
