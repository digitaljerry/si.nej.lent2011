...
Ti.App.days = lang['days'];

// stages used in multiple views
// data from:
// http://lent11.slovenija.net/index.php?eID=tx_mnmysql2json_Table&tx_mnmysql2json[action]=getTable&tx_mnmysql2json[tableName]=tx_cal_location&tx_mnmysql2json[fields]=uid,name,street,zip,city,longitude,latitude&tx_mnmysql2json[where]=deleted=0%20AND%20hidden=0%20AND%20sys_language_uid=0
...
stages[4] = {"uid":"4","name":"Jazzlent","street":"Jazzlent","zip":"2000","city":"Maribor","longitude":"15.641999","latitude":"46.55754"};
stages[5] = {"uid":"5","name":"Večerov oder","street":"Večerov oder","zip":"2000","city":"Maribor","longitude":"15.6435441","latitude":"46.5566618"};
stages[6] = {"uid":"6","name":"Jurčkov oder","street":"Jurčkov oder","zip":"2000","city":"Maribor","longitude":"15.6453895","latitude":"46.5568831"};
stages[7] = {"uid":"7","name":"Sodni stolp","street":"Sodni stolp","zip":"2000","city":"Maribor","longitude":"15.6410336","latitude":"46.5568684"};
stages[10] = {"uid":"10","name":"Vetrinjski dvor","street":"Vetrinjski dvor","zip":"2000","city":"Maribor","longitude":"15.648286","latitude":"46.559734"};
stages[11] = {"uid":"11","name":"Mladinin oder","street":"Mladinin oder","zip":"2000","city":"Maribor","longitude":"15.6415486","latitude":"46.5572815"};
stages[15] = {"uid":"15","name":"Glavni trg ","street":"Glavni trg","zip":"2000","city":"Maribor","longitude":"15.645293","latitude":"46.55765"};
...
stages[18] = {"uid":"18","name":"Klub KGB","street":"Klub KGB","zip":"2000","city":"Maribor","longitude":"15.642686","latitude":"46.557532"};

// not correct geo location!
stages[19] = {"uid":"19","name":"KMŠ oder","street":"KMŠ oder","zip":"2000","city":"Maribor","longitude":"15.6361842","latitude":"46.5580488"};

stages[20] = {"uid":"20","name":"Glavni oder na Dravi","street":"Glavni oder na Dravi","zip":"2000","city":"Maribor","longitude":"15.6486511","latitude":"46.5563224"};
...
stages[27] = {"uid":"27","name":"Trg generala Maistra","street":"Trg generala Maistra","zip":"2000","city":"Maribor","longitude":"15.6492029","latitude":"46.5612573"};
stages[30] = {"uid":"30","name":"Ostala prizorišča","street":"","zip":"2000","city":"Maribor","longitude":"0","latitude":"0"};
stages[28] = {"uid":"28","name":"Trg Svobode","street":"Trg Svobode","zip":"2000","city":"Maribor","longitude":"15.6489726","latitude":"46.5608156"};
stages[29] = {"uid":"29","name":"Dvorana Union","street":"Dvorana Union","zip":"2000","city":"Maribor","longitude":"15.651183","latitude":"46.561088"};

// categories used in multipel views
// data from:
// http://lent11.slovenija.net/index.php?eID=tx_mnmysql2json_Table&tx_mnmysql2json[action]=getTable&tx_mnmysql2json[tableName]=tx_cal_category&tx_mnmysql2json[fields]=uid,title&tx_mnmysql2json[where]=deleted=0%20AND%20hidden=0%20AND%20sys_language_uid=0
categories = Array();
